...
def main(main_window):
    ...
    ButtonRelevMetricRefreshStr = main_window.ButtonRelevMetricRefreshStr
    ButtonRelevMetricRefreshStr.clicked.connect(lambda x: actions.win_relev_metric_refresh(main_window, False, True))
